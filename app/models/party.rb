class Party < ActiveRecord::Base
  ...
  attr_accessible :name, :hex_colour, :website, :image, :image_file_name, :long_name, :email, :phone_number, :address, :facebook, :twitter, :youtube, :notes
  ...
  scope :with_politicians_and_constit, includes(:politicians => :constituency)
